...
void startCallbackiOS() {
  // The setTaskHandler function must be called to handle the task in the background.
  FlutterForegroundTask.setTaskHandler(MyTaskHandleriOS());
}

class MyTaskHandleriOS extends TaskHandler {
  SendPort? _sendPort;
  int _eventCount = 0;
  ...
  void onButtonPressed(String id) {
    // Called when the notification button on the iOS platform is pressed.
    print('onButtonPressed >> $id');
  }

  @override
  void onNotificationPressed() {
    // Called when the notification itself on the iOS platform is pressed.
    //
    // "iOS.permission.SYSTEM_ALERT_WINDOW" permission must be granted for
...
class MapScreeniOS extends StatefulWidget {
  ...
  static String pageRoute = 'MapScreeniOSx';
...
class _MapScreeniOSState extends State<MapScreeniOS> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    print('location start Following FROM MAP_SCREEN_IOS_PRO');
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    print('POINTCANT---> $state !!!!');
    print('POINTCANT---> .  STATE IS $state !!!!');
    print('POINTCANT---> .  STATE IS ${state.name} !!!!');
    ...
    if(state.name == 'resumed'){
      ...
      print('POINTCANT--->       STATE IS ON FOREGROUND');
