        ...
        children: [
          ...
          MaterialButton(
            ...
            onPressed: settingForm.isLoading ? null :  () async{
              ...
              if (settingForm.userPassword.length >= 6 && Preferences.userPassword != settingForm.userPassword){
                final bool changedPassword = await authService.changePassword(token, settingForm.userPassword);
