            ...
            Row(
              children: [
                SizedBox(
                    width: 300,
                    child: Text(
                      '${myHistory.startTimestamp.split(' ')[0]} | ${myHistory.profile == 'walking' ? 'peatón' : 'ciclista'} | ${myHistory.distance}km | ${myHistory.totalTime}min | Exposición: ${myHistory.exposure}ug/m3',
